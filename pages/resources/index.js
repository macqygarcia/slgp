...
export default function Resources({ resources }) {
  ...
  return (
    <div>
      ...
      <ul className="my-20 grid place-items-center gap-10  p-5 sm:mx-auto sm:max-w-md md:max-w-full md:grid-cols-2 md:px-2 lg:grid-cols-3 xl:grid-cols-4 2xl:max-w-7xl 2xl:gap-5">
